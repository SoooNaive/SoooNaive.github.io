...
let cardAdvice = cardTaro.advice;
  ...
  document.getElementById("p").appendChild(h);
  h.setAttribute('id','h');
  document.getElementById("h").append(cardTitle);
  let p = document.createElement('p');
  document.getElementById("p").appendChild(p);
  p.setAttribute('id','d');
  document.getElementById("d").append("Карта дня:   " + cardDescription);
  let a = document.createElement('p');
  document.getElementById("p").appendChild(a);
  a.setAttribute('id','a');
  document.getElementById("a").append("Совет от карты:  " + cardAdvice);
